...
import { idlFactory } from './pub.did.js';
export { idlFactory } from './pub.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PUB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pub.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pub canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pub.did.js")._SERVICE>}
 */
export const pub = createActor(canisterId);
