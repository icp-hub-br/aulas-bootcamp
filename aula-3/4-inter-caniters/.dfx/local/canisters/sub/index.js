...
import { idlFactory } from './sub.did.js';
export { idlFactory } from './sub.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SUB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sub.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sub canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sub.did.js")._SERVICE>}
 */
export const sub = createActor(canisterId);
